...
GiltEdged.studio applies UK economic time-series to an evolving agent-based monetary system [model](https://www.modernmoney.studio/models#abmlp).

### Goal

Better understand [Gilt](#gilt) dynamics as long-term lagged effects of a Government money system bound by agent behaviours and [parameter]({{< ref "/posts/development-roadmap/#model" >}} "A Development Roadmap") rules.
...
- Macro: Yields and prices: System velocity and acceleration.
- Micro: Portfolio management: Household agents and their long-bond price expectations.
...
- The Central Bank sets a rate on interest-bearing money types.
